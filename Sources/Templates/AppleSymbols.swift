...
public extension Group {
    static var appleSymbolsNotes: Group {
        ...
        /*
         ...
         <text style="stroke:none;fill:black;font-family:-apple-system,&quot;SF Pro Display&quot;,&quot;SF Pro Text&quot;,Helvetica,sans-serif;text-anchor:end;" transform="matrix(1 0 0 1 3036 1951)">Generated from folder.circle</text>
    ...
    static var appleSymbolsGuides: Group {
        ...
        hRef.paths = []
        hRef.paths?.append(Path(data: "M 54.9316 0 L 57.666 0 L 30.5664 -70.459 L 28.0762 -70.459 L 0.976562 0 L 3.66211 0 L 12.9395 -24.4629 L 45.7031 -24.4629 Z M 29.1992 -67.0898 L 29.4434 -67.0898 L 44.8242 -26.709 L 13.8184 -26.709 Z"))
    ...
    static func appleSymbols(path: Path) -> Group {
        ...
        group.groups?.append(Group("Black-L", path: path, transform: "matrix(1 0 0 1 2854.05 1556)"))
        group.groups?.append(Group("Heavy-L", path: path, transform: "matrix(1 0 0 1 2558.39 1556)"))
        group.groups?.append(Group("Bold-L", path: path, transform: "matrix(1 0 0 1 2262.88 1556)"))
        group.groups?.append(Group("Semibold-L", path: path, transform: "matrix(1 0 0 1 1966.97 1556)"))
        group.groups?.append(Group("Medium-L", path: path, transform: "matrix(1 0 0 1 1670.87 1556)"))
        group.groups?.append(Group("Regular-L", path: path, transform: "matrix(1 0 0 1 1374.97 1556)"))
        group.groups?.append(Group("Light-L", path: path, transform: "matrix(1 0 0 1 1079.18 1556)"))
        group.groups?.append(Group("Thin-L", path: path, transform: "matrix(1 0 0 1 783.693 1556)"))
        group.groups?.append(Group("Ultralight-L", path: path, transform: "matrix(1 0 0 1 487.616 1556)"))
        
        group.groups?.append(Group("Black-M", path: path, transform: "matrix(1 0 0 1 2870.97 1126)"))
        group.groups?.append(Group("Heavy-M", path: path, transform: "matrix(1 0 0 1 2575.19 1126)"))
        group.groups?.append(Group("Bold-M", path: path, transform: "matrix(1 0 0 1 2279.5 1126)"))
        group.groups?.append(Group("Semibold-M", path: path, transform: "matrix(1 0 0 1 1983.5 1126)"))
        group.groups?.append(Group("Medium-M", path: path, transform: "matrix(1 0 0 1 1687.3 1126)"))
        group.groups?.append(Group("Regular-M", path: path, transform: "matrix(1 0 0 1 1391.3 1126)"))
        group.groups?.append(Group("Light-M", path: path, transform: "matrix(1 0 0 1 1095.42 1126)"))
        group.groups?.append(Group("Thin-M", path: path, transform: "matrix(1 0 0 1 799.806 1126)"))
        group.groups?.append(Group("Ultralight-M", path: path, transform: "matrix(1 0 0 1 503.656 1126)"))
        
        group.groups?.append(Group("Black-S", path: path, transform: "matrix(1 0 0 1 2884.57 696)"))
        group.groups?.append(Group("Heavy-S", path: path, transform: "matrix(1 0 0 1 2588.47 696)"))
        group.groups?.append(Group("Bold-S", path: path, transform: "matrix(1 0 0 1 2292.44 696)"))
        group.groups?.append(Group("Semibold-S", path: path, transform: "matrix(1 0 0 1 1996.2 696)"))
        group.groups?.append(Group("Medium-S", path: path, transform: "matrix(1 0 0 1 1699.83 696)"))
        group.groups?.append(Group("Regular-S", path: path, transform: "matrix(1 0 0 1 1403.58 696)"))
        group.groups?.append(Group("Light-S", path: path, transform: "matrix(1 0 0 1 1107.6 696)"))
        group.groups?.append(Group("Thin-S", path: path, transform: "matrix(1 0 0 1 811.867 696)"))
        group.groups?.append(Group("Ultralight-S", path: path, transform: "matrix(1 0 0 1 515.644 696)"))
